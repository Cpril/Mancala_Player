...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new jxcPlayer(Position.Top, timeLimit);	// TOP player (MAX)
        private static Player pBot = new jxcPlayer2(Position.Bottom, timeLimit);	// BOTTOM player	
